  ...
  return (
    <div className="min-h-screen bg-[#F8F6F1] dark:bg-gray-900 flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-5 py-10 w-full">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl p-6 mb-5 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">1. 왜 만들었나요?</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 italic mb-3">"시험 전 10분, 전공 서적을 다 읽을 순 없으니까!"</p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl p-6 mb-5 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">2. 우리가 함께 만든 기록</h2>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">1,556명+</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">함께 공부한 사람들</p>
            </div>
            <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">73,000+</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">격파한 총 문제 수</p>
            </div>
            <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">67.5%</p>
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl p-6 mb-5 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">3. 앞으로의 계획</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">4. 만든 사람들</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">문제를 발견하고 기술로 해결하는 것을 즐기는 서울 18반 팀입니다.</p>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mb-2">데이터셋 제작에 기여해주신 분들</p>
