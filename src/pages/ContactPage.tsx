  ...
  return (
    <div className="min-h-screen bg-[#F8F6F1] flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-5 py-10 w-full">
        <h1 className="text-2xl font-bold text-gray-800 mb-8">Contact</h1>
        ...
        <section className="bg-white rounded-xl p-6 mb-5 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">문의 이메일</h2>
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-sm">
              <span className="text-gray-500 w-20 shrink-0">이메일</span>
              <a href="mailto:qe092783@gmail.com" className="text-blue-600 hover:underline">
                qe092783@gmail.com
              </a>
            </div>
            <div className="flex items-start gap-3 text-sm">
              <span className="text-gray-500 w-20 shrink-0">설문조사</span>
              <a
        ...
        <section className="bg-white rounded-xl p-6 mb-5 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 mb-3">이런 내용을 보내주시면 좋아요</h2>
        ...
        <section className="bg-white rounded-xl p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-800 mb-3">참고 사항</h2>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start gap-2"><span className="text-gray-400 mt-0.5">•</span> 본 서비스는 학습 보조를 목적으로 제작된 프로젝트입니다.</li>
            <li className="flex items-start gap-2"><span className="text-gray-400 mt-0.5">•</span> 문의 내용에 따라 답변까지 다소 시간이 걸릴 수 있습니다.</li>
            <li className="flex items-start gap-2"><span className="text-gray-400 mt-0.5">•</span> 문제 오류 제보 시 <strong>문제 번호, 문제 내용, 신고 사유</strong>를 함께 보내주시면 더 빠르게 확인할 수 있습니다.</li>
          </ul>
