  ...
  return (
    <Modal onClose={onClose}>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-gray-800">🚨 문제 오류 신고</h3>
      ...
      <div className="mb-4">
        <p className="text-sm font-semibold text-gray-700 mb-2">신고 유형</p>
        {REPORT_TYPES.map((rt) => (
      ...
      <div className="mb-4">
        <p className="text-sm font-semibold text-gray-700 mb-1.5">상세 내용</p>
        <textarea
      ...
      <div className="mb-4">
        <p className="text-sm font-semibold text-gray-700 mb-1.5">올바른 답 (선택)</p>
        <input
          type="text"
      ...
      <div className="flex gap-3 justify-end">
        <button
          onClick={onClose}
          className="px-5 py-2 rounded-full text-sm text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors"
        >
          취소
        </button>
        <button
